    ...
    <div class="aparece" style="padding-left: 30%; padding-right: 30%">
        <form id="askForm" action="{$BASE_URL}actions/perguntas/create_pergunta.php" method="post" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-xs-12 col-md-12">
                    <input type="text" name="conteudo" placeholder="Description" style="width: 100%; height: 100px; margin-top: 10px; border-style: none;">
                </div>
                <div class="col-xs-12 col-md-8">
                    <input type="text" name="tags" placeholder="tags" style="width: 100%; margin-top: 10px; border-style: none; height: 33px">
                </div>
                <div class="col-xs-12 col-md-4" style="text-align: right; border-style: none;">
                    <button type="submit" class="btn btn-default" style="background-color: #f44937; color: white; margin-top: 10px;">post question</button>
                </div>
